...
class CompetencyProcessor(DataProcessor):
  """Processor for the competency dataset."""
...
def main(_):
  ...
  processors = {
      ...
      "mrpc": MrpcProcessor,
      "xnli": XnliProcessor,
      "competency": CompetencyProcessor,
  }
